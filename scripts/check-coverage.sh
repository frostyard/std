...
# Ported from frostyard/clix (scripts/check-coverage.sh), itself ported from
# frostyard/updex. std floors the reporter package at 95.0%
# (`make coverage-check`); observed coverage is 97.7%.
#
